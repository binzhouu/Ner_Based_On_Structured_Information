...
from model.cnn_lstm_attn_crf import CnnLstmAttnCrf, CnnLstmAttnCrfConfig
...
def train():
	...
	for idx in range(config.epoch):
		...
		for batch_id in range(total_batch):
			...
			loss, tag_seq = model(
				batch_word, batch_features, batch_wordlen, batch_char, batch_charlen, batch_charrecover, mask, batch_label)
